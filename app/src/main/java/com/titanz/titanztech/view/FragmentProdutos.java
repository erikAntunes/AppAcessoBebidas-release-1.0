...
public class FragmentProdutos extends Fragment implements ServicosListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        produtos1.setNome("Desenvolvimento  Android Mobile");
        ...
        produtos2.setNome("Formatação de Notebooks");
        ...
        produtos3.setNome("Formatação de Desktops");
        ...
        produtos4.setNome("Backup de Arquivos Pessoais");
        ...
        produtos5.setNome("Troca de Teclado   Notebook");
        ...
        produtos6.setNome("Troca de HD   Notebook / Desktop");
        ...
        produtos7.setNome("Montagem de Desktop Gamer");
        ...
        produtos8.setNome("Upgrade de Memória RAM");
        ...
        produtos9.setNome("Upgrade   HD para SSD");

...
public class FragmentCombos extends Fragment implements PromocoesListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        combos1.setNome("Aplicativo Android Comercial");
        ...
        combos1.setValor("R$ 500,00");
        combosArrayList.add(combos1);

        Combos combos2 = new Combos();
        combos2.setNome("Formatação + Limpeza - Notebook ");
        ...
        combos3.setNome("Formatação + Limpeza - Desktop");
        ...
        combos3.setValor("R$ 100,00");
        combosArrayList.add(combos3);

        Combos combos4 = new Combos();
        combos4.setNome("Formatação + SSD 120GB");
        ...
        combos4.setValor("R$ 260,00");
        combosArrayList.add(combos4);

        Combos combos5 = new Combos();
        combos5.setNome("Formatação + SSD 240GB");
        ...
        combos5.setValor("R$ 350,00");
        combosArrayList.add(combos5);

        Combos combos6 = new Combos();
        combos6.setNome("Formatação + SSD 480GB");
        ...
        combos6.setValor("R$ 440,00");
        combosArrayList.add(combos6);

        Combos combos7 = new Combos();
        combos7.setNome("Recuperação de Arquivos Pessoais");
